...
public class MovieSessionController {
    ...
    public void update(@RequestBody MovieSessionRequestDto movieSessionRequestDto) {
        movieSessionService.update(movieSessionMapper.toMovieSessionEntity(movieSessionRequestDto));
    }

    @DeleteMapping
    public void delete(@RequestBody MovieSessionRequestDto movieSessionRequestDto) {
        movieSessionService.delete(movieSessionMapper.toMovieSessionEntity(movieSessionRequestDto));
    }
}
